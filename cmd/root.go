...
import (
	...
	"github.com/gkwa/funnyfacilitator/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.funnyfacilitator.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".funnyfacilitator")
	}
